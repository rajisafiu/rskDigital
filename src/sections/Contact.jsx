...
const Contact = () => {
  ...
  const whatsappNumber = "+2348146150972"; 
  const whatsappMessage = encodeURIComponent("Hi RSK Digital! I'm interested in starting a project with you.");
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-xl mx-auto mb-12 leading-relaxed">
            Have a project in mind or just want to chat about potential growth? 
            Reach out via email or message me directly on WhatsApp.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
            {/* Primary Email Button */}
            <a
              href="mailto:rajikolawole677@gmail.com"
              className="w-full sm:w-auto group relative px-10 py-4 bg-white text-black font-bold rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.1)]"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-10 py-4 bg-[#25D366]/10 border border-[#25D366]/30 text-[#25D366] font-bold rounded-full hover:bg-[#25D366]/20 transition-all hover:scale-105 active:scale-95"
            >
              <svg 
                className="w-5 h-5" 
                fill="currentColor" 
