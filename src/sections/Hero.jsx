  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-6 pt-32 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Hi, I’m <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-blue-600">Raji Safiu Kolawole</span>
        </motion.h1>
        ...
        <motion.h2 
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="text-2xl md:text-5xl font-bold text-slate-200 mb-8"
        >
          Building <span className="italic font-serif">high-conversion</span> digital experiences.
        </motion.h2>
        ...
        >
          <a
            href="#projects"
            className="w-full sm:w-auto px-10 py-4 bg-white text-black font-bold rounded-2xl hover:bg-blue-50 transition-all shadow-[0_20px_40px_rgba(255,255,255,0.1)] active:scale-95 text-center"
          >
            View Portfolio
          </a>
          ...
          <a
            href="#contact"
            className="w-full sm:w-auto px-10 py-4 bg-white/5 border border-white/10 text-white font-bold rounded-2xl backdrop-blur-xl hover:bg-white/10 transition-all active:scale-95 text-center"
          >
